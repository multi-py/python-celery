...
```dockerfile
FROM ghcr.io/multi-py/python-celery:py3.11-5.3.4
...
## Tags
* Recommended Image: `ghcr.io/multi-py/python-celery:py3.11-5.3.4`
* Slim Image: `ghcr.io/multi-py/python-celery:py3.11-slim-5.3.4`
